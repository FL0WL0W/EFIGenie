...
namespace Service
{
	...
	IInjectionConfig *ServiceBuilder::CreatePistonEngineInjetionConfig(ServiceLocator *serviceLocator, void *config, unsigned int *totalSize)
	{
	...
	IIgnitionConfig *ServiceBuilder::CreateIgnitionConfig(ServiceLocator *serviceLocator, void *config, unsigned int *totalSize)
	{	
	...
	ICrankCamDecoder *ServiceBuilder::CreateDecoderService(ServiceLocator *serviceLocator, void *config, unsigned int *totalSize)
	{
