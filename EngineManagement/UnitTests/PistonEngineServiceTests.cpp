...
//		MockPistonEngineInjectionConfig _pistonEngineInjectionConfig;
//		MockPistonEngineIgnitionConfig _pistonEngineIgnitionConfig;
...
//
//			_pistonEngineServiceIgnitionOnly = new PistonEngineService(_pistonEngineConfig, 0, 0, &_pistonEngineIgnitionConfig, _ignitorOutputServices, &_timerService, &_decoder);
//			_pistonEngineServiceInjectionOnly = new PistonEngineService(_pistonEngineConfig, &_pistonEngineInjectionConfig, _injectorOutputServices, 0, 0, &_timerService, &_decoder);
//			_pistonEngineService = new PistonEngineService(_pistonEngineConfig, &_pistonEngineInjectionConfig, _injectorOutputServices, &_pistonEngineIgnitionConfig, _ignitorOutputServices, &_timerService, &_decoder);
//		}
//
...
//			EXPECT_CALL(_pistonEngineIgnitionConfig, GetIgnitionTiming()).WillOnce(Return(10));
//
