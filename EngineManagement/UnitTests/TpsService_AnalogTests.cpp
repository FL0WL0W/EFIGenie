...
namespace UnitTests
{
	TEST_CLASS(TpsService_AnalogTests)
	{
	public:
		...
		TEST_METHOD(WhenGettingTpsThenCorrectTpsIsReturned)
		{
			...
			EngineManagement::CurrentThrottlePositionService->ReadTps();
			Assert::AreEqual(-10.0f, EngineManagement::CurrentThrottlePositionService->Tps, 0.1f);
			Assert::AreEqual(0.0f, EngineManagement::CurrentThrottlePositionService->TpsDot, 0.1f);
			...
			EngineManagement::CurrentThrottlePositionService->ReadTps();
			Assert::AreEqual(20.0f, EngineManagement::CurrentThrottlePositionService->Tps, 0.1f);
			Assert::AreEqual(10000.0f, EngineManagement::CurrentThrottlePositionService->TpsDot, 0.1f);
			...
			EngineManagement::CurrentThrottlePositionService->ReadTps();
			Assert::AreEqual(-1.25f, EngineManagement::CurrentThrottlePositionService->Tps, 0.001f);
			Assert::AreEqual(10000.0f, EngineManagement::CurrentThrottlePositionService->TpsDot, 0.1f);
			...
			EngineManagement::CurrentThrottlePositionService->ReadTps();
			Assert::AreEqual(-1.25f, EngineManagement::CurrentThrottlePositionService->Tps, 0.001f);
			Assert::AreEqual(-10625.0f, EngineManagement::CurrentThrottlePositionService->TpsDot, 0.1f);
		}
	};
}