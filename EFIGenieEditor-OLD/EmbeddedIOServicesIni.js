...
var VariableSelections = [
    ...
    { Name: "Operation Immediate", IniName: "Variable_OperationImmediate" },
...
var EmbeddedIOServicesIni = {
    ...
    Variable_StaticScalar: {  Output: "ScalarVariable", Inputs: [], Variables : [
        ...
        { VariableID: { Type: "uint16", Value: "[]", Static: true } },
        { Value: { IniName: "ScalarVariable", Label: "" } }
    ] },
    Variable_DigitalPinRecord: {  Output: "Record", Inputs: [], Variables : [
    ...
    Variable_Operation: {  Output: "Operation/Output", Inputs: "Operation/Inputs", Variables : [
        ...
        { VariableInputIDs: { Array: ".Inputs/length", Variables : [
            { Variable: { Label: "....Inputs/[]/Label", Type: "uint16", Selections: "/VariableBus", FilterOn: "Output", Filter: "....Inputs/[]/Type" } },
        ] } }
    ] },
    ...
    IVariable: { Output: "Selection/Output", Inputs: "Selection/Inputs", Variables : [
        { BUILDER_VARIABLE: { Type: "uint16", Value: 7001, Static: true } },
        { Selection: { Label: "Input", Selections: VariableSelections } }
    ] },

    Operation_2AxisTable: { Output: "ScalarVariable", Inputs: [{ Label: "X", Type: "ScalarVariable"}, { Label: "Y", Type: "ScalarVariable"}], Variables : [
    ...
    Operation_DigitalPinWrite: { Output: false, Inputs: [{ Label: "Value", Type: "ScalarVariable"}], Variables : [
    ...
    Operation_FaultDetectionConfig: { Output: "ScalarVariable", Inputs: [{ Label: "Value", Type: "ScalarVariable"}], Variables : [
    ...
    Operation_Math: { Output: "ScalarVariable", Inputs: [{ Label: "A", Type: "ScalarVariable"}, { Label: "B", Type: "ScalarVariable"}], Variables : [
    ...
    Operation_Polynomial: { Output: "ScalarVariable", Inputs: [{ Label: "Value", Type: "ScalarVariable"}], Variables : [
    ...
    Operation_ScheduleCallBack: { Output: false, Inputs: [{ Label: "Tick", Type: "ScalarVariable"}], Variables : [
        { FactoryID: { Type: "uint16", Value: 15, Static: true } },
        { VariableFactoryID: { Type: "uint16", Value: ".Operation/Selection/FactoryID", Static: true } },
        { VariableOutputID: { Type: "uint16", Value: "[]", Static: true, ExcludeFromBin: "!.Output" } },
        { Operation: { Label: "Operation", Type: "uint16", Selections: "/OperationBus" } },
        { VariableInputIDs: { Array: ".Operation/Inputs/length", Variables : [
            { Variable: { Label: "....Operation/Inputs/[]/Label", Type: "uint16", Selections: "/VariableBus", FilterOn: "Output", Filter: "....Operation/Inputs/[]/Type" } },
        ] } }
    ] },
    Operation_SecondsToTicks: { Output: "ScalarVariable", Inputs: [{ Label: "Seconds", Type: "ScalarVariable"}], Variables : [
        { FactoryID: { Type: "uint16", Value: 17, Static: true } }
    ] },
    Operation_TicksToSeconds: { Output: "ScalarVariable", Inputs: [{ Label: "Ticks", Type: "ScalarVariable"}], Variables : [
        { FactoryID: { Type: "uint16", Value: 18, Static: true } }
    ] },
