...
// {
// 	class Operation_EngineScheduleInjection : public IOperation<std::tuple<ScalarVariable, ScalarVariable>, EnginePosition, ScalarVariable, ScalarVariable>
// 	{
// 	protected:
...
// 		bool _open = false;
// 	public:		
//         Operation_EngineScheduleInjection(EmbeddedIOServices::ITimerService *timerService, float tdc, IOperation<void, ScalarVariable> *injectionOutputOperation);
